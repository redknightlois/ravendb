        ...
        internal sealed class TestingStuff
        {
            ...
            public Task<TResource> Replace(string databaseName, Task<TResource> task)
            {
                lock (_parent)
                {
                    ...
                    // We need to refresh all of them.
                    _parent._readonlyCaseSensitive = _parent._caseSensitive.ToFrozenDictionary();
                    _parent._readonlyCaseInsensitive = _parent._caseInsensitive.ToFrozenDictionary();
                    _parent._readonlyResourceDetails = _parent._resourceDetails.ToFrozenDictionary();
