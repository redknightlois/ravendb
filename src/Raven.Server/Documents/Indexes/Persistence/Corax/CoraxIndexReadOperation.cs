...
namespace Raven.Server.Documents.Indexes.Persistence.Corax
{
    public class CoraxIndexReadOperation : IndexReadOperationBase
    {
        ...
        protected struct IdentityTracker<TDistinct> where TDistinct : struct, IHasDistinct
        {
            ...
            public void Initialize(LowLevelTransaction llt, Index index, IndexQueryServerSide query, IndexSearcher searcher, TermsReader documentIdReader, IndexFieldsMapping fieldsMapping, IQueryResultRetriever<QueriedDocument> retriever)
            {
                _llt = llt;
                _index = index;
                _query = query;
