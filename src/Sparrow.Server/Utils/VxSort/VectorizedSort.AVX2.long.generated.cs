/////////////////////////////////////////////////////////////////////////////
//
// This file was auto-generated by a tool at 2022-11-25 14:16:25
//
...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        internal struct Int64Config
        {
            ...
            public int Unroll => 8;
            public int SlackPerSideInVectors => Unroll;
            public int SlackPerSideInElements => SlackPerSideInVectors * N;
            ...
            public int PartitionTempSizeInElements => (2 * SlackPerSideInElements + N + 4 * N);   
            public int PartitionTempSizeInBytes => PartitionTempSizeInElements * sizeof(long);
            public int ElementAlign => sizeof(long) - 1;    
        }
        ...
        private long* vectorized_partition_8(long* left, long* right, long hint)
        {
            ...
            var config = default(Int64Config); 
            int N = config.N;
            int SMALL_SORT_THRESHOLD_ELEMENTS = config.SmallSortThresholdElements;
            int PARTITION_TMP_SIZE_IN_ELEMENTS = config.PartitionTempSizeInElements;
            ...
            *right = int.MaxValue;
            ...
            {
                if ((byte*)writeRight - (byte*)readRightV < (2 * (unroll * N) - N) * sizeof(long))
                {
            ...
            while (readLeftV < readRightV)
            {
                if ((byte*)writeRight - (byte*)readRightV < (2 * (unrollHalf * N) - N) * sizeof(long))
                {
            ...
            while (readLeftV <= readRightV)
            {
                if ((byte*)writeRight - (byte*)readRightV < N * sizeof(long))
                {
                    nextPtr = readRightV;
                    readRightV -= N;                                
                }
