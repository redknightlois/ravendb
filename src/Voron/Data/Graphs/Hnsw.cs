...
public unsafe partial class Hnsw
{
    ...
    public partial class SearchState : IDisposable
    {
        ...
        // Owns the allocation for a normalized copy of the query vector when the static entry points need to build one. Null when the caller (e.g. Corax) already supplies a normalized query. Released in Dispose.
