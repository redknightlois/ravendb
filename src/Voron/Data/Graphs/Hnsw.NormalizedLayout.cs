...
public partial class Hnsw
{
    ...
    /// allocating when no normalization is needed (wrong similarity method, legacy on-disk
    /// version, or the input is already in storage form). Throws when the input is not a raw
