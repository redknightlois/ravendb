...
public sealed partial class CompactTree : IPrepareForCommit
{
    ...
    public unsafe struct CompactKeyLookup : ILookupKey
    {
        ...
        public void OnNewKeyAddition<T>(Lookup<T> parent) where T : struct, ILookupKey
        {
            ...
            IncrementTermReferenceCount(parent.Llt, (long)ContainerId);
        }
        ...
        public int GetTermRefCount<T>(Lookup<T> parent) where T : struct, ILookupKey
        {
            ...
            var term = Container.Get(parent.Llt, (long)ContainerId);
        ...
        {
            var term = Container.GetMutable(llt, (ContainerEntryId)keyContainerId);
            int termRefCount = term[0] & 0xF;
